...
namespace WebApplication2.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            ViewBag.UserType = new SelectList(_context.Roles.Where(r=>!r.Name.Contains("Adminstrator")).ToList(),
                "Name","Name");
            return View();
        }
        ...
        //Get
        public ActionResult EditProfile(HttpPostedFileBase UserPhoto)
        {
            var Currentuserid = User.Identity.GetUserId();
            var currentuser = _context.Users.Where(a => a.Id == Currentuserid).SingleOrDefault();
            EditProfileViewModel profile=new EditProfileViewModel();

            //string path=Path.Combine(Server.MapPath("~/UserPhotos"),UserPhoto.FileName);
            //UserPhoto.SaveAs(path);
            //profile.UserImg= UserPhoto.FileName;
        ...
        public ActionResult EditProfile(EditProfileViewModel profile)
        {
            ...
            {
                ViewBag.Message1 = "Sorry..Password is wrong,please enter the right password";
            }
            else
            {
                ...
                ViewBag.Message2 = "Changes Done Successfully";
            }
            return View(profile);
        }
        //
